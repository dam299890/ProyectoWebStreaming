...
include 'consultar-favoritos.php';
include 'consultar-episodios.php';


function generarPelicula($fila,$tarifa) {
    ...
    if(($tarifa== "2" and $fila["anyo"] >= 2020) || 
      ($tarifa== "1" and $fila["anyo"] >= 2015)){
      echo '<div class="icon-container">';
      echo '<button type="button" class="btn btn-secondary example-popover" data-bs-custom-class="custom-popover" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="top" data-bs-content="No incluido en tu tarifa">';
    ...
    echo '</div>';
    if (($tarifa == "1" and $fila["anyo"] < 2015) || 
        ($tarifa== "2" and $fila["anyo"] < 2020)||
        ($tarifa == "3" )) {
      ...
      echo '<h1 class="modal-title fs-5">' . $fila['nombre_contenido'] . '</h1>';
      ...
      echo '<button type="submit" class="btn btn-secondary btn-fav" onclick="insertarDatos(' . $fila["id_contenido"] . '); toggleFav(this);">';
